...
import { Route as AuthenticatedCvsIndexRouteImport } from './routes/_authenticated/cvs/index'
...
const AuthenticatedCvsIndexRoute = AuthenticatedCvsIndexRouteImport.update({
  id: '/cvs/',
  path: '/cvs/',
  getParentRoute: () => AuthenticatedRouteRoute,
} as any)
...
export interface FileRoutesByFullPath {
  ...
  '/register-complete': typeof authRegisterCompleteRoute
...
declare module '@tanstack/react-router' {
  interface FileRoutesByPath {
    ...
    '/_authenticated/job-roles/': {
      ...
      path: '/job-roles'
      fullPath: '/job-roles/'
      preLoaderRoute: typeof AuthenticatedJobRolesIndexRouteImport
      parentRoute: typeof AuthenticatedRouteRoute
    }
    '/_authenticated/interviews/': {
    ...
    '/_authenticated/cvs/': {
      ...
      path: '/cvs'
      fullPath: '/cvs/'
      preLoaderRoute: typeof AuthenticatedCvsIndexRouteImport
      parentRoute: typeof AuthenticatedRouteRoute
    }
    '/_authenticated/contacts/': {
