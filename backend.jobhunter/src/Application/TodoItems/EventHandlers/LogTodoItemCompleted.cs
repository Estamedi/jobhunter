using backend.jobhunter.Domain.Events;
using Microsoft.Extensions.Logging;

namespace backend.jobhunter.Application.TodoItems.EventHandlers;
...
public class LogTodoItemCompleted : INotificationHandler<TodoItemCompletedEvent>
{
    ...
    {
        _logger.LogInformation("backend.jobhunter Domain Event: {DomainEvent}", notification.GetType().Name);
